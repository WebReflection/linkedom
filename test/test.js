module.exports = async ({CustomEvent, DOMParser, parseHTML}) => {
...
assert(!node.isEqualNode({}), 'isEqualNode nope');
...
assert(attr.childNodes.length === 0, 'empty childNodes from Node prototype');
