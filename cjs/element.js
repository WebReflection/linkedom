'use strict';
const {Type, invalidOperation, link} = require('./common.js');
const {Node} = require('./node.js');
const {ClassList} = require('./class-list.js');
const {ATTRIBUTE_NODE, Attribute} = require('./attribute.js');
const {COMMENT_NODE} = require('./comment.js');
const {TEXT_NODE} = require('./text.js');

const DOCUMENT_FRAGMENT_NODE = Type.Fragment;
const ELEMENT_END_NODE = Type.ElementEnd;

const ELEMENT_NODE = Type.Element;
